...
export const NEIGHBOUR_BILL_UNPAID = "Neighbour bill unpaid";
export const NEIGHBOUR_DEAL_ENDED = "Neighbour deal ended";
export const NEIGHBOUR_RATE_CHANGED = "Neighbour rate changed";
export const NEIGHBOURS_CHANGED = "Neighbour deals changed";
export const NEIGHBOUR_WINDOW_CLOSED = "Neighbour window closed";
export const NEIGHBOUR_WINDOW_REQUESTED = "Neighbour window requested";
...
export const ORDINANCES_CHANGED = "Ordinances changed";
export const ORDINANCE_WINDOW_CLOSED = "Ordinance window closed";
export const ORDINANCE_WINDOW_REQUESTED = "Ordinance window requested";
...
export const HIGH_SCORE_REQUESTED = "High score requested";
export const HIGH_SCORE_WINDOW_CLOSED = "High score window closed";
